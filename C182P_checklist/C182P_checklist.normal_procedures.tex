...
\begin{checklist}{Preflight}
    ...
    \checkitem{Alt. Static}{Check Closed}
    ...
    \checkitem{Light}{Nav/Stro/Land/Bea}
...
\begin{checklist}{Before Takeoff}
    ...
    \checkitem{Takeoff Checklist}{Review}
    \begin{center}
    ...
    % emergency?
    \checkitem{Lose Power On Runway}{Briefed}
    \checkitem{Lose Power After Runway}{Briefed}
    \centering{
        (below \& above $\approx$ 1000' AGL)
        \\
    }
\end{checklist}
...
\begin{checklist}{Cruise Climb \> 1000 AGL}
    \checkitem{Target Airspeed}{87-96 KIAS}
    \checkitem{Power/Prop}{23"/2450 RPM}
    \checkitem{Mixture}{Rich}
    \checkitem{Cowl Flaps}{As Req.}
\end{checklist}

\begin{checklist}{Cruise}
    \checkitem{Power/Prop}{15"-23"/2200-2450 RPM}
...
\begin{checklist}{Descent}
    ...
    \checkitem{ATIS/Specials}{Copied} 
...
\begin{checklistg}{Before Landing}
    ...
    \checkitem{Fuel Selector}{Both}
    \checkitem{Mixture}{Rich}
    \checkitem{Propellor}{Slow to High RPM}
    \checkitem{Cowl Flaps}{As Req.}
...
\begin{checklistg}{Securing Aircraft}
    ...
    \checkitem{Magnetos}{Off \& Show Key}
...
\begin{checklist}{V-Speeds}
    ...
    \checkitem{$V_R$ (flaps 0\degree{}/20\degree{})}{60/50 KIAS}
