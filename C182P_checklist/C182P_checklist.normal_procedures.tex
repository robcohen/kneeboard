...
\begin{checklist}{Preflight}
    ...
    \checkitem{Emergency Equipment}{List}
...
\begin{checklist}{Engine Run-Up}
    ...
    \checkitem{Throttle}{Idle, 700/Carb In}
...
\begin{checklist}{Takeoff}
    ...
    \checkitem{Targ. Airspeed}{53-78 KIAS}
    \checkitem{Flaps}{0-20}
    \checkitem{Mixture}{Full Rich/Target EGT}
...
\begin{checklist}{Enroute Climb}
    \checkitem{Targ. Airspeed}{87-96 KIAS}
