...
\newcommand{\bookemptyweight}{1761}
\newcommand{\maxgrossweight}{3000}
% Approximately two 160 lb adults, 20 lb of baggage, and 58 gal of fuel remaining.
\newcommand{\grossweight}{2450}
...
% gross weights."
\newcommand{\maneuveringspeed}{\fpeval{96 + (\grossweight - \bookemptyweight) * ((124 - 96) / (\maxgrossweight - \bookemptyweight))}}
...
\newcommand{\bestglidespeed}{\scaledvspeed{85}}

\phantomsection
\addcontentsline{toc}{subsection}{Dakota flight maneuver entry speeds at \num{\grossweight} lbf}
