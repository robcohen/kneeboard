...
\begin{checklist}{Pre-Maneuver}
    \checkitem{Altitude}{Above 1,500' AGL}
    \checkitem{Fuel pump}{on}
    \checkitem{Mixture}{lean for max power}
    \checkitem{Clearing turns}{complete}
    % TODO: Should put prop full forward, slow to maneuver entry speed.
\end{checklist}
...
\begin{checklist}{Engine Shutdown}
    \checkitem{G5 Master \& Avionics}{off}
